...
export function EditTools() {
  ...
  // Ref holding the cleanup function for any in-progress drag gesture.
  // Drag handlers (erase / range-select / new-note) register their
  // window-level listener teardown here so the unmount effect below
  // can call it if the component is removed mid-drag (e.g. the user
  // starts playback while dragging).
  ...
  // returns to the browser default. Also clean up any in-progress
  // drag gesture's window listeners.
  useEffect(() => {
    return () => {
